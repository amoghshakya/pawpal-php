...
<main>
    <div class="banner <?= $pet->status->name === 'available' ? 'success' : 'warning' ?>">
        <div class="content">
            <p>
                <?php if ($pet->status->name === 'available'): ?>
                    This listing is currently set as available for adoption. Please
                    ensure that all information is accurate and up-to-date before
                    updating the listing.
                <?php else: ?>
                    This listing is marked as adopted. If you need to update the status or
                    details, please do so carefully to maintain accurate records.
                <?php endif; ?>
            </p>
        </div>
        <div class="actions">
            <form method="POST" action="<?= BASE_URL . '/pets/' . $pet->id . '/edit' ?>" id="toggle-status-form">
                <input type="hidden" name="action" value="toggle_status" />
                <button class="secondary" type="submit">
                    <?= $pet->status->name === 'available' ? 'Mark as Adopted' : 'Mark as Available' ?>
                </button>
            </form>
            ...
            <div id="delete-confirmation-modal" class="modal hidden">
                <div class="modal-content">
                    <div class="close-btn" onclick="document.getElementById('delete-confirmation-modal').classList.add('hidden')">
                    ...
                    <div class="modal-body">
                        <h4 class="modal-title">Delete listing for <?= htmlspecialchars($pet->name) ?></h4>
                    ...
                    <div class="modal-footer">
                        <div class="button-container">
                            <form method="POST" action="<?= BASE_URL . '/pets/' . $pet->id . '/edit' ?>">
                                <input type="hidden" name="action" value="delete_listing" />
                                <button class="danger" type="submit">Delete</button>
                            </form>
                            <button class="secondary" type="button" onclick="document.getElementById('delete-confirmation-modal').classList.add('hidden')">
                                Cancel
                            </button>
                        </div>
