@php
    $base =
        "w-full inline-flex items-center justify-center px-4 py-2 gap-2 whitespace-nowrap font-medium rounded-md text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 cursor-pointer";
    $variants = [
